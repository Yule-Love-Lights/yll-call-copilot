// /second-mile — the second-mile task queue (reveal photos, personal
// touches, the December cookies+ornament run, cold-snap check-ins). Server
// component so we can check Supabase config server-side, same pattern as
// /queue and /verticals.

import Link from 'next/link';
import { isSupabaseConfigured } from '@/lib/supabase';
import SecondMileQueue from './SecondMileQueue';
