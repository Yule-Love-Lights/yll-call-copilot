// /verticals/[id] — edit a vertical's description/knowledge notes, generate
// and edit its playbook, and browse/restore version history. Server
// component so we can check Supabase config server-side (same pattern as
// /verticals and /contacts).
...
export default async function VerticalDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-12">
      <Link href="/verticals" className="text-sm text-zinc-500 hover:underline">
        ← Verticals
      </Link>
