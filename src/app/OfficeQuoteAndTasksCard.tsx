      ...
      <div className="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
        <div>
          ...
          <h2 id="office-quote-and-tasks-heading" className="mt-1 text-base font-semibold text-[var(--op-text)]">
            Quote timing and quote-origin tasks are not connected yet
          </h2>
          <p className="mt-1 text-sm leading-5 text-[var(--op-text-2)]">
            Quote Tool must first publish its approved lifecycle event feed. Until then, this Hub does not estimate turnaround, workload, promises, or quote task ownership from inbox and contact data. Manual Hub tasks remain available below.
          </p>
        </div>
