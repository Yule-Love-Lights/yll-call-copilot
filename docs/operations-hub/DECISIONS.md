...
| 17 | Versioned cross-repository contract | PARTIALLY COMPLETE: the normative Markdown, manifest, OpenAPI, and generated JSON Schema are published and mirrored byte-identically through `v1.5.0-draft`; authenticated cross-repository CI and deploy-skew smoke remain open | Phase 0 contract gate |
