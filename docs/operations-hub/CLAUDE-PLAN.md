# Claude-side plan: P4P labor tracking + operations (the Quote Tool side of the Operations Hub)

> **Status:** Claude working plan, preserved unmodified for comparison per the merge
> protocol in CODEX-PLAN.md section 31. Written 2026-08-06 by the AI Quote Tool's
> assistant from three Q&A rounds with Naldo plus a five-lens adversarial review.
> Canonical source: `yll-quote-tool` repo, `docs/context/project_p4p_labor.md`
> (PR #701). This copy is the comparison input; if they drift, the quote tool copy
> wins.
>
> **Scope note for the comparison:** this plan was written BEFORE reading
> CODEX-PLAN.md and centers on the Quote Tool side: budgeted hours from design
> geometry, the P4P pay engine, scheduling, the Telegram bot, and the legal
> constraints on performance pay. It places crew identity and time capture in the
> Quote Tool, which conflicts with the hub-owns-attendance boundary in
> CODEX-PLAN.md section 20 and Naldo's later source-of-truth instruction. That
> conflict is real and goes to PLAN-COMPARISON.md, not silently resolved here.
