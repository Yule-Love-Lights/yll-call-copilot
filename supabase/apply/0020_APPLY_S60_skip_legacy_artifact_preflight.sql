...
-- [S60 SKIPPED — see runbook] do $legacy_metric_artifact_preflight$
-- [S60 SKIPPED — see runbook] declare
-- [S60 SKIPPED — see runbook]   v_weekly_digests bigint;
-- [S60 SKIPPED — see runbook]   v_brain_reviews bigint;
-- [S60 SKIPPED — see runbook]   v_playbook_proposals bigint;
-- [S60 SKIPPED — see runbook]   v_edited_playbook_versions bigint;
-- [S60 SKIPPED — see runbook] begin
-- [S60 SKIPPED — see runbook]   select count(*) into v_weekly_digests
-- [S60 SKIPPED — see runbook]   from public.weekly_digests;
-- [S60 SKIPPED — see runbook] 
-- [S60 SKIPPED — see runbook]   select count(*) into v_brain_reviews
-- [S60 SKIPPED — see runbook]   from public.brain_reviews;
-- [S60 SKIPPED — see runbook] 
-- [S60 SKIPPED — see runbook]   select count(*) into v_playbook_proposals
-- [S60 SKIPPED — see runbook]   from public.playbook_proposals;
-- [S60 SKIPPED — see runbook] 
-- [S60 SKIPPED — see runbook]   select count(*) into v_edited_playbook_versions
-- [S60 SKIPPED — see runbook]   from public.playbook_versions
-- [S60 SKIPPED — see runbook]   where source = 'edited';
-- [S60 SKIPPED — see runbook] 
-- [S60 SKIPPED — see runbook]   if v_weekly_digests > 0
-- [S60 SKIPPED — see runbook]     or v_brain_reviews > 0
-- [S60 SKIPPED — see runbook]     or v_playbook_proposals > 0
-- [S60 SKIPPED — see runbook]     or v_edited_playbook_versions > 0
-- [S60 SKIPPED — see runbook]   then
-- [S60 SKIPPED — see runbook]     raise exception using
-- [S60 SKIPPED — see runbook]       errcode = '55000',
-- [S60 SKIPPED — see runbook]       message = format(
-- [S60 SKIPPED — see runbook]         'Legacy metric artifacts require reconciliation before migration 0020 (weekly_digests=%s, brain_reviews=%s, playbook_proposals=%s, edited_playbook_versions=%s); export them, remove reviews/digests/proposals and edited versions, reset each affected vertical.active_version to a retained generated version, then recreate only verified manual edits after 0020',
-- [S60 SKIPPED — see runbook]         v_weekly_digests,
-- [S60 SKIPPED — see runbook]         v_brain_reviews,
-- [S60 SKIPPED — see runbook]         v_playbook_proposals,
-- [S60 SKIPPED — see runbook]         v_edited_playbook_versions
-- [S60 SKIPPED — see runbook]       );
-- [S60 SKIPPED — see runbook]   end if;
-- [S60 SKIPPED — see runbook] end
-- [S60 SKIPPED — see runbook] $legacy_metric_artifact_preflight$;
